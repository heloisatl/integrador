<div id="guia">
    ...
    <section class="guia-pagina">
        ...
        <section class="guia-bloco">
            <div class="guia-titulo-bloco"><span class="guia-numero">01</span>
                <div>
                    <p class="guia-etiqueta">Primeiros passos</p>
                    <h3>Como começar</h3>
                </div>
            </div>
            <div class="guia-passos">
                <article class="guia-passo"><span>1</span>
                    <div>
                        <h4>Acesse o DevStudio</h4>
                        <p>Abra o sistema pela URL da pasta <code>public</code>. A página inicial apresenta os atalhos e o resumo das ferramentas.</p>
                    </div>
                </article>
                ...
                <article class="guia-passo"><span>3</span>
                    <div>
                        ...
                        <p>Gere um sistema PHP pelo <strong>MVC Creator</strong> ou monte uma interface HTML pelo <strong>Page Maker</strong>.</p>
                    </div>
                </article>
                <article class="guia-passo"><span>4</span>
                    <div>
                        <h4>Confira e aproveite</h4>
                        <p>Use a prévia, acompanhe o histórico e consulte a saída para copiar ou baixar o código gerado.</p>
                    </div>
                </article>
            </div>
        </section>
        ...
        <section class="guia-bloco">
            <div class="guia-titulo-bloco"><span class="guia-numero">02</span>
                <div>
                    <p class="guia-etiqueta">Funcionalidades</p>
                    <h3>Conheça cada área</h3>
                </div>
            </div>
            <div class="guia-camadas">
                ...
                <article class="guia-camada"><span class="guia-icone">MVC</span>
                    <div>
                        <h4>MVC Creator</h4>
                        <p>Gera Controllers, Models, Repositories/DAO e Views CRUD a partir das tabelas do seu banco de dados.</p><a class="guia-link" href="<?= URL_BASE ?>/projetos/mvc-creator">Abrir MVC Creator →</a>
                    </div>
                </article>
                <article class="guia-camada"><span class="guia-icone">HTML</span>
                    <div>
                        <h4>Page Maker</h4>
                        <p>Cria páginas HTML e CSS com cabeçalho, navegação, imagens, colunas, cards, formulários, botões e prévia responsiva.</p><a class="guia-link" href="<?= URL_BASE ?>/projetos/pagemaker">Abrir Page Maker →</a>
                    </div>
                </article>
                <article class="guia-camada"><span class="guia-icone">OUT</span>
                    <div>
                        <h4>Saída</h4>
                        <p>Centraliza os códigos produzidos pelas ferramentas para visualizar, copiar e baixar cada arquivo gerado.</p><a class="guia-link" href="<?= URL_BASE ?>/projetos/saida">Ver saída →</a>
                    </div>
                </article>
                <article class="guia-camada"><span class="guia-icone">HIS</span>
                    <div>
                        <h4>Histórico</h4>
                ...
                <article class="guia-camada"><span class="guia-icone">PER</span>
                    <div>
                        <h4>Perfil e tema</h4>
                        <p>No menu Perfil, alterne entre tema claro e escuro. Quando estiver autenticado, também poderá sair da conta.</p>
                    </div>
                </article>
            </div>
        </section>
        ...
        <section class="guia-bloco">
            <div class="guia-titulo-bloco"><span class="guia-numero">03</span>
                <div>
                    <p class="guia-etiqueta">Gerador PHP</p>
                    <h3>Como usar o MVC Creator</h3>
                </div>
            </div>
        ...
        <section class="guia-bloco">
            <div class="guia-titulo-bloco"><span class="guia-numero">04</span>
                <div>
                    <p class="guia-etiqueta">Criador visual</p>
                    <h3>Como usar o Page Maker</h3>
                </div>
            </div>
        ...
        <section class="guia-bloco">
            ...
            <div class="guia-passos">
                <article class="guia-passo"><span>1</span>
                    <div>
                        <h4>Revise na Saída</h4>
                        <p>Confira os arquivos separados por tipo e verifique se o conteúdo gerado corresponde ao que foi configurado.</p>
                    </div>
                </article>
                <article class="guia-passo"><span>2</span>
                    <div>
                        <h4>Copie ou baixe</h4>
                        <p>Use os controles de cada bloco para copiar o código ou salvar os arquivos no computador.</p>
                    </div>
                </article>
                <article class="guia-passo"><span>3</span>
                    <div>
                        <h4>Coloque no servidor</h4>
                        <p>Use o código em XAMPP, WAMP, Docker ou outro ambiente PHP/HTML.</p>
                    </div>
                </article>
                <article class="guia-passo"><span>4</span>
                    <div>
                        <h4>Retome depois</h4>
                        <p>Consulte o Histórico para encontrar atividades e continuar seu trabalho com mais organização.</p>
                    </div>
                </article>
            </div>
        </section>
