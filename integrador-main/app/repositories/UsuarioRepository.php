...
class UsuarioRepository {
    ...
    public function getUsuarioByIdComSenha(int $id): array|false {
        $sql  = "SELECT id_usuario, nome, email, senha_usuario, tipo_perfil FROM usuario WHERE id_usuario = :id";
        $stmt = $this->connection->prepare($sql);
        $stmt->bindValue(':id', $id, PDO::PARAM_INT);
        $stmt->execute();
    ...
    public function createUsuario(array $dados): bool {
        $sql = "INSERT INTO usuario (nome, email, senha_usuario, tipo_perfil) 
